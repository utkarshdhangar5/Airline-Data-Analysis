...
## Dataset Description : The dataset consists of multiple relational tables 
- aircrafts_data → Aircraft details
- airports_data → Airport & city information
- flights → Flight schedules tickets
...
- evenue by fare class (Business, Economy, Comfort)
- Aircraft performance analysis
- Route-level revenue insights
- Occupancy and capacity utilization

## Key Insights: 
- Business class contributes the highest revenue despite lower passenger volume Revenue shows strong seasonal trends with peak demand periods.
